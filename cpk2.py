...
__CHANNEL_USERNAME__ = "LÊ NGUYỄN NHẬT HÀO"
__GROUP_USERNAME__   = "Zalo : 0352112387"
...
def banner(console):
    ...
    console.print("[bold green]♕ LÊ NGUYỄN NHẬT HÀO[/bold green]: Car Parking Multiplayer Hacking Tool.")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan](01): Buff Tiền [/bold cyan]")
            console.print("[bold cyan](02): Buff Coin [/bold cyan]")
            console.print("[bold cyan](03): Rank King 156đ [/bold cyan]")
            console.print("[bold cyan](04): Thay Đổi ID [/bold cyan]")
            console.print("[bold cyan](05): Thay Đổi Tên [/bold cyan]")
            console.print("[bold cyan](06): Thay Đổi Tên (MÀU) [/bold cyan]")
            console.print("[bold cyan](07): Biển Số [/bold cyan]")
            console.print("[bold cyan](08): Xóa Tài Khoản [/bold cyan]")
            console.print("[bold cyan](09): Đăng kí tài khoản [/bold cyan]")
            console.print("[bold cyan](10): Xóa Bạn Bè [/bold cyan]")
            console.print("[bold cyan](11): Mở Khóa Xe [/bold cyan]")
            console.print("[bold cyan](12): Mở Khóa Tất Cả Xe [/bold cyan]")
            console.print("[bold cyan](13): Mở Còi [/bold cyan]")
            console.print("[bold cyan](14): Mở khóa Động Cơ W16 [/bold cyan]")
            console.print("[bold cyan](15): Mở Tất Cả Nhà [/bold cyan]")
            console.print("[bold cyan](16): Mở khóa Vô hiệu hóa Sát thương [/bold cyan]")
            console.print("[bold cyan](17): Mở khóa nhiên liệu không giới hạn [/bold cyan]")
            console.print("[bold cyan](18): Mở khóa Nhà 3 [/bold cyan]")
            console.print("[bold cyan](19): Mở khóa khói [/bold cyan]")
            console.print("[bold cyan](20): Thay đổi cuộc đua chiến thắng [/bold cyan]")
            console.print("[bold cyan](21): Thay đổi cuộc đua thua cuộc [/bold cyan]")
            #console.print("[bold cyan](22): Sao chép tài khoản [/bold cyan]")
